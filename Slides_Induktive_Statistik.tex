...
\def\mathematicaltheoremboxcolor{blue}
\preto{\mthmn}{
    \setbeamercolor{block title}{fg=black,bg=\mathematicaltheoremboxcolor!70!white}
    \setbeamercolor{block body}{fg=black, bg=\mathematicaltheoremboxcolor!20!white}
}
