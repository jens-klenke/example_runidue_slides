...
%---------------- CSL / citeproc for Beamer - clickable -------------------------
\newlength{\cslhangindent}
\setlength{\cslhangindent}{1.5em}

% 1) bibliography environment
...
{%
	...
	\begin{list}{}{%
			...
			\setlength{\itemsep}{\dimexpr #2\baselineskip\relax}%
			\setlength{\topsep}{0pt}\setlength{\partopsep}{0pt}}%
		\raggedright
	}{\end{list}\par}
\providecommand{\citeproctext}{} % silent fallback
\providecommand{\CSLBlock}[1]{#1\hfill\break}
\providecommand{\CSLRightInline}[1]{\hspace{1em}#1}
\providecommand{\CSLIndent}[1]{\hspace{\cslhangindent}#1}

%------------------- Changes for hyperlink -------------------------
% 2) Hyperlink layer (Beamer already loads hyperref)
\providecommand{\Hypertarget}[2]{\hypertarget{#1}{#2}}
\providecommand{\Hyperlink}[2]{\hyperlink{#1}{#2}}
\providecommand{\citeproc}[2]{\Hyperlink{#1}{#2}}

% 3) Patch \bibitem so each entry gets an anchor BEFORE the real \item
...
%%% Additional packages
\makeatletter
\def\input@path{{"C:/Users/Vineet.Dairashri/AppData/Local/R/win-library/4.3/runidue/rmarkdown/templates/lectureslides/resources/"}}  % make them visible to tex to overcome warnings
\makeatother

\input{ee.sty}
\input{BeamerColor.sty}
\usepackage{xcolor}
\usepackage{hypernat}
...
\newcommand{\SD}{\operatorname{SD}}
\providecommand{\mathcolor}[2]{\begingroup\color{#1}#2\endgroup}
...
\newenvironment<>{kahoot}[1]{%
  \begin{actionenv}#2%
      ...
      \begin{center}
					...
					\ifstrequal{FALSE}{FALSE}{}{\begin{minipage}[t][1cm]{1.9cm}\includegraphics[height=1cm,keepaspectratio=true,valign=t, right]{FALSE}\end{minipage}\vspace{-.3cm}}
...
\newenvironment<>{QuizAcademy}[1]{%
	\begin{actionenv}#2%
		...
		\begin{center}
				...
				\includegraphics[width=0.25\textwidth]{"C:/Users/Vineet.Dairashri/AppData/Local/R/win-library/4.3/runidue/rmarkdown/templates/lectureslides/resources/QuizAcademy.png"}  
...
\newenvironment<>{Quiz}[1]{%	
	...
	\end{center}}
	{\par\usebeamertemplate{block end}\end{actionenv}}
\newcommand{\Quizblock}[1]{\begin{Quiz}{#1}\end{Quiz}}
...
\makeatother
\newcommand{\R}{\includegraphics[height=.85\fsize, clip=T]{"C:/Users/Vineet.Dairashri/AppData/Local/R/win-library/4.3/runidue/rmarkdown/templates/lectureslides/resources/Rlogo"}\ }
...
% user-defined color for exe\Exercise
\def\exerciseboxcolor{blue}
\preto{\exe}{
	\setbeamercolor{block title}{fg=black, bg=\exerciseboxcolor!70!white}
	\setbeamercolor{block body}{fg=black, bg=\exerciseboxcolor!20!white}
}


\def\beispielboxcolor{yellow}
\preto{\xmpl}{
    \setbeamercolor{block title}{fg=black,bg=\beispielboxcolor!70!white}
    \setbeamercolor{block body}{fg=black, bg=\beispielboxcolor!20!white}
   
}

\def\lemmaboxcolor{blue}
\preto{\lem}{
    \setbeamercolor{block title}{fg=black,bg=\lemmaboxcolor!70!white}
    \setbeamercolor{block body}{fg=black, bg=\lemmaboxcolor!20!white}
   
}

\def\definitionboxcolor{green}
\preto{\defn}{
    \setbeamercolor{block title}{fg=black,bg=\definitionboxcolor!70!white}
    \setbeamercolor{block body}{fg=black, bg=\definitionboxcolor!20!white}
}

\def\theoremboxcolor{blue}
\preto{\thmn}{
    \setbeamercolor{block title}{fg=black,bg=\theoremboxcolor!70!white}
    \setbeamercolor{block body}{fg=black, bg=\theoremboxcolor!20!white}
}

\def\corollaryboxcolor{blue}
\preto{\cor}{
    \setbeamercolor{block title}{fg=black,bg=\corollaryboxcolor!70!white}
    \setbeamercolor{block body}{fg=black, bg=\corollaryboxcolor!20!white}
}

\def\assumptionboxcolor{blue}
\preto{\ass}{
    \setbeamercolor{block title}{fg=black,bg=\assumptionboxcolor!70!white}
    \setbeamercolor{block body}{fg=black, bg=\assumptionboxcolor!20!white}
}

\def\remarkboxcolor{blue}
\preto{\rem}{
    \setbeamercolor{block title}{fg=black,bg=\remarkboxcolor!70!white}
    \setbeamercolor{block body}{fg=black, bg=\remarkboxcolor!20!white}
}

\def\propositionboxcolor{blue}
\preto{\prop}{
    \setbeamercolor{block title}{fg=black,bg=\propositionboxcolor!70!white}
    \setbeamercolor{block body}{fg=black, bg=\propositionboxcolor!20!white}
}

\def\frageboxcolor{blue}
\preto{\que}{
    \setbeamercolor{block title}{fg=black,bg=\frageboxcolor!70!white}
    \setbeamercolor{block body}{fg=black, bg=\frageboxcolor!20!white}
}

\def\maththeoremboxcolor{blue}
\preto{\mthmn}{
    \setbeamercolor{block title}{fg=black,bg=\maththeoremboxcolor!70!white}
    \setbeamercolor{block body}{fg=black, bg=\maththeoremboxcolor!20!white}
}
...
%%\ifstrequal{FALSE}{FALSE}{}{\includegraphics[width=2cm,keepaspectratio=true, valign=t]{FALSE}\vspace{-.3cm}}
%    
...
\begin{document}
      ...
      {\usebackgroundtemplate{\includegraphics[scale=0.25]{"C:/Users/Vineet.Dairashri/AppData/Local/R/win-library/4.3/runidue/rmarkdown/templates/lectureslides/resources/duetower"}}
...
\phantomsection\label{uxfcberblick}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{details-zur-veranstaltung}
\begin{itemize}
\tightlist
\item
  Kontakt:
...
\phantomsection\label{ressourcen}
\begin{itemize}
\item
  \hil{Literatur:}
...
\begin{frame}{F \& A}
\phantomsection\label{f-a}
\centerline{Spezielle Fragen?}
\end{frame}

\begin{frame}{Überblick}
\phantomsection\label{uxfcberblick-1}
\begin{itemize}
\tightlist
\item
  Organisatorisches
...
\phantomsection\label{was-ist-uxf6konometrie-und-wofuxfcr-brauchen-wir-sie}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{Was ist Ökonometrie und wofür brauchen wir sie?}
\phantomsection\label{was-ist-uxf6konometrie-und-wofuxfcr-brauchen-wir-sie-1}
\begin{itemize}
\item
...
\begin{frame}{Was ist Ökonometrie und wofür brauchen wir sie?}
\phantomsection\label{was-ist-uxf6konometrie-und-wofuxfcr-brauchen-wir-sie-2}
...
\begin{frame}{Was ist Ökonometrie und wofür brauchen wir sie?}
\phantomsection\label{was-ist-uxf6konometrie-und-wofuxfcr-brauchen-wir-sie-3}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{Was ist Ökonometrie und wofür brauchen wir sie?}
\phantomsection\label{was-ist-uxf6konometrie-und-wofuxfcr-brauchen-wir-sie-4}
...
\phantomsection\label{gesundheitsuxf6konomisches-beispiel}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{Gesundheitsökonomisches Beispiel}
\phantomsection\label{gesundheitsuxf6konomisches-beispiel-1}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{Gesundheitsökonomisches Beispiel}
\phantomsection\label{gesundheitsuxf6konomisches-beispiel-2}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{Gesundheitsökonomisches Beispiel}
\phantomsection\label{gesundheitsuxf6konomisches-beispiel-3}
\xmpl[*]
...
\begin{frame}{Gesundheitsökonomisches Beispiel}
\phantomsection\label{gesundheitsuxf6konomisches-beispiel-4}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{ziel-der-veranstaltung}
\begin{itemize}
\tightlist
\item
  Sie werden \ldots{}
...
\begin{frame}{Überblick}
\phantomsection\label{uxfcberblick-2}
\begin{itemize}
\tightlist
\item
  Organisatorisches
...
\phantomsection\label{wiederholung}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{zufallsvariable}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{Zufallsvariable}
\phantomsection\label{zufallsvariable-1}
...
\begin{frame}{Momente}
\phantomsection\label{momente-1}
...
\phantomsection\label{gemeinsame-verteilung}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{Bedingte Verteilung}
\phantomsection\label{bedingte-verteilung-1}
\xmpl[Löhne aus dem US CPS]
...
\phantomsection\label{bedingte-momente}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{Bedingte Momente}
\phantomsection\label{bedingte-momente-2}
\xmpl[Löhne aus dem US CPS]
...
\begin{frame}{Bedingte Momente}
\phantomsection\label{bedingte-momente-3}
\footnotesize
...
\begin{frame}{Bedingte Momente}
\phantomsection\label{bedingte-momente-4}
\xmpl[Löhne aus dem US CPS]
...
\begin{frame}{Bedingte Momente}
\phantomsection\label{bedingte-momente-5}
\footnotesize
...
\begin{frame}{Bedingte Momente}
\phantomsection\label{bedingte-momente-6}
\framesubtitle{Rechenregeln}
...
\phantomsection\label{eigenschaften-der-bedingten-erwartung}
...
\begin{frame}{Eigenschaften der bedingten Erwartung}
\phantomsection\label{eigenschaften-der-bedingten-erwartung-1}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{Überblick}
\phantomsection\label{uxfcberblick-3}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{bedingte-erwartung-und-prognose}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{optimale-vorhersage}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{optimales-g}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{eigenschaften-des-regressionsfehlers}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{bedingtes-erwartungswertmodell}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{verschiedene-perspektiven}
\begin{itemize}
\item
...
\begin{frame}{Überblick}
\phantomsection\label{uxfcberblick-4}
\begin{itemize}
\tightlist
\item
  Bedingte Erwartung
...
\phantomsection\label{lineare-projektion}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{lineare-projektionskoeffizienten}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{blp-und-projektionsfehler}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{lineares-projektionsmodell}
...
\phantomsection\label{weitere-interpretation-des-blp}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{Überblick}
\phantomsection\label{uxfcberblick-5}
\begin{itemize}
\tightlist
\item
  Bedingte Erwartung
...
\phantomsection\label{potential-outcomes-framework}
\xmpl[Lohnregression]
...
\item
  ...
  (\citeproc{ref-Rub74}{1974}) ein\ldots{}
\end{itemize}
\end{frame}

\begin{frame}{Potential Outcomes Framework}
\phantomsection\label{potential-outcomes-framework-1}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{Potential Outcomes Framework}
\phantomsection\label{potential-outcomes-framework-2}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{schuxe4tzung-des-ate}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{Schätzung des ATE}
\phantomsection\label{schuxe4tzung-des-ate-1}
\xmpl[Lohnregression]
...
\phantomsection\label{erweiterung-unseres-frameworks}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{bedingte-unabhuxe4ngigkeitsannahme}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{verbindung-atex-und-bef-mdx}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{Verbindung \(ATE(x)\) und BEF \(m(d,x)\)}
\phantomsection\label{verbindung-atex-und-bef-mdx-1}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{Verbindung \(ATE(x)\) und BEF \(m(d,x)\)}
\phantomsection\label{verbindung-atex-und-bef-mdx-2}
...
\begin{frame}{Verbindung \(ATE(x)\) und BEF \(m(d,x)\)}
\phantomsection\label{verbindung-atex-und-bef-mdx-3}
...
\phantomsection\label{verbindung-atex-und-regressionskoeffizienten}
...
\phantomsection\label{beispiel-bef-und-ate}
...
\begin{frame}{Beispiel: BEF und ATE}
\phantomsection\label{beispiel-bef-und-ate-1}
\xmpl[*]
...
\begin{frame}{Überblick}
\phantomsection\label{uxfcberblick-6}
\begin{itemize}
\tightlist
\item
  Bedingte Erwartung
...
\phantomsection\label{zusammenhuxe4nge-in-kuxfcrze}
...
\begin{frame}{Zusammenhänge in Kürze}
\phantomsection\label{zusammenhuxe4nge-in-kuxfcrze-1}
...
\phantomsection\label{drei-interpretationen}
...
\phantomsection\label{das-lineare-modell}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{Überblick}
\phantomsection\label{uxfcberblick-7}
\begin{itemize}
\tightlist
\item
  \textbf{KQ Schätzer}
...
\phantomsection\label{kq-schuxe4tzer}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{KQ Schätzer}
\phantomsection\label{kq-schuxe4tzer-1}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{visualisierung-kq-schuxe4tzer}
\footnotesize
...
\begin{frame}{Visualisierung KQ Schätzer}
\phantomsection\label{visualisierung-kq-schuxe4tzer-1}
\footnotesize
...
\begin{frame}{Visualisierung KQ Schätzer}
\phantomsection\label{visualisierung-kq-schuxe4tzer-2}
\footnotesize
...
\begin{frame}{Visualisierung KQ Schätzer}
\phantomsection\label{visualisierung-kq-schuxe4tzer-3}
\footnotesize
...
\begin{frame}{Visualisierung KQ Schätzer}
\phantomsection\label{visualisierung-kq-schuxe4tzer-4}
\footnotesize
...
\begin{frame}{Visualisierung KQ Schätzer}
\phantomsection\label{visualisierung-kq-schuxe4tzer-5}
\footnotesize
...
\phantomsection\label{kq-schuxe4tzer-in}
\xmpl[Card (1995)]\label{ex:Card}

\begin{itemize}
\tightlist
\item
  Betrachten Sie die Lohnregression von Card
  (\citeproc{ref-Car95}{1995}) \[
...
\phantomsection\label{kq-schuxe4tzer-in-1}
\footnotesize
...
\begin{frame}[fragile]{KQ Schätzer in \R}
\phantomsection\label{kq-schuxe4tzer-in-2}
\footnotesize
...
\phantomsection\label{matrixnotation}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{positive-definitheit}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{Positive Definitheit}
\phantomsection\label{positive-definitheit-1}
\xmpl
\begin{itemize}
...
\begin{frame}{Überblick}
\phantomsection\label{uxfcberblick-8}
\begin{itemize}
\tightlist
\item
  KQ Schätzer
...
\phantomsection\label{terminologie}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{visualisierung-in}
...
\phantomsection\label{projektionsmatrix}
...
\begin{frame}{Projektionsmatrix}
\phantomsection\label{projektionsmatrix-1}
...
\begin{frame}{Projektionsmatrix}
\phantomsection\label{projektionsmatrix-2}
...
\begin{frame}{Projektionsmatrix}
\phantomsection\label{projektionsmatrix-3}
\xmpl[*]
...
\phantomsection\label{residuenmachermatrix}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{angepasste-werte-und-residuen}
...
\begin{frame}{Angepasste Werte und Residuen}
\phantomsection\label{angepasste-werte-und-residuen-1}
\footnotesize
...
\begin{frame}{Angepasste Werte und Residuen}
\phantomsection\label{angepasste-werte-und-residuen-2}
...
\begin{frame}{Überblick}
\phantomsection\label{uxfcberblick-9}
\begin{itemize}
\tightlist
\item
  KQ Schätzer
...
\phantomsection\label{fwl-theorem}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{FWL Theorem}
\phantomsection\label{fwl-theorem-1}
...
\begin{frame}{FWL Theorem}
\phantomsection\label{fwl-theorem-2}
...
\begin{frame}{FWL Theorem}
\phantomsection\label{fwl-theorem-3}
...
\phantomsection\label{anwendung-des-fwl-theorems}
...
\begin{frame}{Überblick}
\phantomsection\label{uxfcberblick-10}
\begin{itemize}
\tightlist
\item
  KQ Schätzer
...
\phantomsection\label{tss-ess-und-ssr}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{unzentriertes-r2}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{zentriertes-r2}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{stichprobe}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{Überblick}
\phantomsection\label{uxfcberblick-11}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{erwartungswert}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{Erwartungswert}
\phantomsection\label{erwartungswert-1}
...
\phantomsection\label{illustration-der-unverzerrtheit-in}
...
\phantomsection\label{illustration-der-unverzerrtheit-in-1}
\footnotesize
...
\begin{frame}{Illustration der Unverzerrtheit in \R}
\phantomsection\label{illustration-der-unverzerrtheit-in-2}
\footnotesize
...
\phantomsection\label{illustration-der-bedingten-unverzerrtheit-in}
\xmpl[Simulationsbeispiel]
...
\phantomsection\label{illustration-der-bedingten-unverzerrtheit-in-1}
\footnotesize
...
\begin{frame}{Illustration der bedingten Unverzerrtheit in \R}
\phantomsection\label{illustration-der-bedingten-unverzerrtheit-in-2}
\footnotesize
...
\begin{frame}{Überblick}
\phantomsection\label{uxfcberblick-12}
\begin{itemize}
\tightlist
\item
  Erwartungswert
...
\phantomsection\label{varianz-kovarianz-matrix}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{Varianz}
\phantomsection\label{varianz-1}
\begin{itemize}
\item
...
\begin{frame}{Varianz}
\phantomsection\label{varianz-2}
...
\begin{frame}{Varianz}
\phantomsection\label{varianz-3}
\framesubtitle{Homoskedastie}
...
\begin{frame}{Varianz}
\phantomsection\label{varianz-4}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{illustration-von-heteroskedastie-in}
\xmpl[Card (1995)]

\begin{itemize}
\tightlist
\item
  Erinnern Sie sich an die Lohnregression von Card
  (\citeproc{ref-Car95}{1995}) aus Beispiel~\ref{ex:Card}: \[
   \log(wage) = \beta_0+\beta_1\cdot educ + e.
   \]
\item
...
\phantomsection\label{unbedingte-varianz}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{Überblick}
\phantomsection\label{uxfcberblick-13}
\begin{itemize}
\tightlist
\item
  Erwartungswert
...
\phantomsection\label{gaussmarkov-theorem}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{illustration-des-gmt-via-beispiel}
\xmpl[Simulationsbeispiel]
...
\R Beispiel}
\phantomsection\label{illustration-des-gmt-via-beispiel-1}
\footnotesize
...
\begin{frame}{Überblick}
\phantomsection\label{uxfcberblick-14}
\begin{itemize}
\tightlist
\item
  Erwartungswert
...
\phantomsection\label{ausschluss-relevanter-variablen}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{Ausschluss relevanter Variablen}
\phantomsection\label{ausschluss-relevanter-variablen-1}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{inklusion-irrelevanter-variablen}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{Inklusion irrelevanter Variablen}
\phantomsection\label{inklusion-irrelevanter-variablen-1}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{zusammenfassung}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{Überblick}
\phantomsection\label{uxfcberblick-15}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{wiederholung-asymptotischer-theorie}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{konvergenzmodi}
...
\begin{frame}{Konvergenzmodi}
\phantomsection\label{konvergenzmodi-1}
...
\phantomsection\label{regeln-fuxfcr-konvergenzen}
\begin{enumerate}
\tightlist
\item
...
\begin{frame}{Regeln für Konvergenzen}
\phantomsection\label{regeln-fuxfcr-konvergenzen-1}
\begin{enumerate}
\setcounter{enumi}{2}
\tightlist
\item
...
\phantomsection\label{zwei-klassiker}
...
\phantomsection\label{illustration-des-zgws}
...
\begin{frame}{Überblick}
\phantomsection\label{uxfcberblick-16}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{konsistenz}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{illustration-von-konsistenz}
\xmpl
...
Inkonsistenz}
\phantomsection\label{illustration-von-inkonsistenz}
...
\begin{frame}{Überblick}
\phantomsection\label{uxfcberblick-17}
\begin{itemize}
\tightlist
\item
  Wiederholung asymptotischer Theorie
...
\phantomsection\label{asymptotische-normalituxe4t}
\begin{itemize}
\tightlist
\item
  Konsistenz zeigt
...
\begin{frame}{Asymptotische Normalität}
\phantomsection\label{asymptotische-normalituxe4t-1}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{Asymptotische Normalität}
\phantomsection\label{asymptotische-normalituxe4t-2}
...
\phantomsection\label{illustration-1}
\footnotesize
...
\phantomsection\label{illustration-2}
\footnotesize
...
\phantomsection\label{diskussion-von-theorem}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{Ausblick}
\phantomsection\label{ausblick-1}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{Überblick}
\phantomsection\label{uxfcberblick-18}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{hypothesen}
...
\phantomsection\label{teststatistik-und-kritische-werte}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{Teststatistik und kritische Werte}
\phantomsection\label{teststatistik-und-kritische-werte-1}
\xmpl
...
\phantomsection\label{fehler-1.-art}
...
\phantomsection\label{fehler-2.-art}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{fehler-1.-und-2.-art}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{Fehler 1.~und 2.~Art}
\phantomsection\label{fehler-1.-und-2.-art-1}
...
\begin{frame}{Überblick}
\phantomsection\label{uxfcberblick-19}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{bedingte-homoskedastie}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{schuxe4tzer-von-mq_xxprime-1-und-sigma2}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{konsistenz-von-widehatsigma2}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{Zusammenfassung}
\phantomsection\label{zusammenfassung-1}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{anwendung}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{Überblick}
\phantomsection\label{uxfcberblick-20}
\begin{itemize}
\tightlist
\item
  Wiederholung Testtheorie
...
\phantomsection\label{bedingte-heteroskedastie}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{Bedingte Heteroskedastie}
\phantomsection\label{bedingte-heteroskedastie-1}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{konsistenz-von-widehatmomega-und-widehatmv_vbetatexthc0}
...
\begin{frame}{Überblick}
\phantomsection\label{uxfcberblick-21}
\begin{itemize}
\tightlist
\item
  Wiederholung Testtheorie
...
\phantomsection\label{t-test-in}
\xmpl[Card (1995)]\label{ex:Card1}

\begin{itemize}
\tightlist
\item
  Wir erweitern die Lohnregression von Card (\citeproc{ref-Car95}{1995})
  um weitere Regressoren: \begin{align*}
...
\phantomsection\label{t-test-im-beispiel}
\footnotesize
...
\phantomsection\label{wald-test}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{Wald Test}
\phantomsection\label{wald-test-1}
\framesubtitle{Die Konstruktion}
...
\begin{frame}{Wald Test}
\phantomsection\label{wald-test-2}
\framesubtitle{Die Konstruktion}
...
\begin{frame}{Wald Test}
\phantomsection\label{wald-test-3}
...
\phantomsection\label{wald-test-in}
\xmpl[Card (1995)]
...
\begin{frame}{Überblick}
\phantomsection\label{uxfcberblick-22}
\begin{itemize}
\tightlist
\item
  Wiederholung Testtheorie
...
\phantomsection\label{konfidenzintervalle}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{allgemeine-konstruktion}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{vthetavaprimevbeta}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{1.~\(\vtheta=\va^\prime\vbeta\)}
\phantomsection\label{vthetavaprimevbeta-1}
...
\begin{frame}{1.~\(\vtheta=\va^\prime\vbeta\)}
\phantomsection\label{vthetavaprimevbeta-2}
...
\begin{frame}{1.~\(\vtheta=\va^\prime\vbeta\)}
\phantomsection\label{vthetavaprimevbeta-3}
...
\phantomsection\label{vthetavaprimevbeta-4}
\framesubtitle{\R Illustration}
...
\begin{frame}{1.~\(\vtheta=\va^\prime\vbeta\)}
\phantomsection\label{vthetavaprimevbeta-5}
\framesubtitle{\R Illustration}
...
\phantomsection\label{vthetamrprimevbeta}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{2.~\(\vtheta=\mR^\prime\vbeta\)}
\phantomsection\label{vthetamrprimevbeta-1}
\thmn
...
\begin{frame}{Ausblick}
\phantomsection\label{ausblick-2}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{Ausblick}
\phantomsection\label{ausblick-3}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{Überblick}
\phantomsection\label{uxfcberblick-23}
\begin{itemize}
\tightlist
\item
  \textbf{Beispiele}
...
\phantomsection\label{regressionen-mit-ausgelassenen-variablen}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{messfehler-in-den-regressoren}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{2. Messfehler in den Regressoren}
\phantomsection\label{messfehler-in-den-regressoren-1}
\xmpl
...
\begin{frame}{2. Messfehler in den Regressoren}
\phantomsection\label{messfehler-in-den-regressoren-2}
\footnotesize
...
\phantomsection\label{simultane-gleichungssyteme}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{3. Simultane Gleichungssyteme}
\phantomsection\label{simultane-gleichungssyteme-1}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{Überblick}
\phantomsection\label{uxfcberblick-24}
\begin{itemize}
\tightlist
\item
  Beispiele
...
\phantomsection\label{instrumente}
...
\phantomsection\label{instrumentexogenituxe4t-ezevzero}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{nicht-redundanz-der-instrumente-ez-zprime0}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{instrumentrelevanz-rkbigezxprimebigk}
\begin{itemize}
\tightlist
\item
  Die Annahme
...
\begin{frame}{Instrumentrelevanz: \(\rk\big(\E[ZX^\prime]\big)=k\)}
\phantomsection\label{instrumentrelevanz-rkbigezxprimebigk-1}
...
\begin{frame}{Instrumentrelevanz: \(\rk\big(\E[ZX^\prime]\big)=k\)}
\phantomsection\label{instrumentrelevanz-rkbigezxprimebigk-2}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{Zusammenfassung}
\phantomsection\label{zusammenfassung-2}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{Überblick}
\phantomsection\label{uxfcberblick-25}
\begin{itemize}
\tightlist
\item
  Beispiele
...
\phantomsection\label{iv-schuxe4tzer}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{IV Schätzer}
\phantomsection\label{iv-schuxe4tzer-1}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{IV Schätzer}
\phantomsection\label{iv-schuxe4tzer-2}
\xmpl
...
\phantomsection\label{mehr-zum-iv-schuxe4tzer}
\begin{itemize}
\tightlist
\item
  Wegen
...
\phantomsection\label{beispiel-4}
\footnotesize
...
\begin{frame}{Überblick}
\phantomsection\label{uxfcberblick-26}
\begin{itemize}
\tightlist
\item
  Beispiele
...
\phantomsection\label{tsls-schuxe4tzer}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{TSLS Schätzer}
\phantomsection\label{tsls-schuxe4tzer-1}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{zwei-interpretationen}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{Zwei Interpretationen}
\phantomsection\label{zwei-interpretationen-1}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{mehr-zum-tsls-schuxe4tzer}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{beispiel-5}
\xmpl[*]
...
\begin{frame}{Überblick}
\phantomsection\label{uxfcberblick-27}
\begin{itemize}
\tightlist
\item
  Beispiele
...
\phantomsection\label{asymptotische-eigenschaften}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{Konsistenz}
\phantomsection\label{konsistenz-1}
...
\begin{frame}{Konsistenz}
\phantomsection\label{konsistenz-2}
...
\begin{frame}{Asymptotische Normalität}
\phantomsection\label{asymptotische-normalituxe4t-3}
...
\begin{frame}{Asymptotische Normalität}
\phantomsection\label{asymptotische-normalituxe4t-4}
...
\phantomsection\label{asymptotische-varianz}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{Asymptotische Varianz}
\phantomsection\label{asymptotische-varianz-1}
\begin{itemize}
...
\phantomsection\label{beispiel-6}
...
\begin{frame}[fragile,allowframebreaks]{\R Beispiel}
\phantomsection\label{beispiel-7}
\footnotesize
...
\begin{frame}{Überblick}
\phantomsection\label{uxfcberblick-28}
\begin{itemize}
\tightlist
\item
  Beispiele
...
\phantomsection\label{testen-uxfcberidentifizierender-restriktionen}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{sargans-teststatistik}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{sargans-test}
...
\phantomsection\label{kommentare}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{Beispiel}
\phantomsection\label{beispiel-8}
\xmpl[Card (1995)]
...
\begin{frame}{Überblick}
\phantomsection\label{uxfcberblick-29}
\begin{itemize}
\tightlist
\item
  Beispiele
...
\phantomsection\label{motivation-fuxfcr-endogenituxe4tstest}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{endogenituxe4tstest}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{Endogenitätstest}
\phantomsection\label{endogenituxe4tstest-1}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{wuhausman-test}
...
\phantomsection\label{die-vorlesung-in-drei-folien}
...
\begin{frame}{Die Vorlesung in drei Folien}
\phantomsection\label{die-vorlesung-in-drei-folien-1}
...
\begin{frame}{Die Vorlesung in drei Folien}
\phantomsection\label{die-vorlesung-in-drei-folien-2}
...
\phantomsection\label{referenzen-1}
\phantomsection\label{refs}
\begin{CSLReferences}{1}{0}
\bibitem[\citeproctext]{ref-Car95}
...
\bibitem[\citeproctext]{ref-Rub74}
