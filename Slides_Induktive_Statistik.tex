...
\newenvironment<>{kahoot}[1]{%
  \begin{actionenv}#2%
      ...
      \begin{center}
					...
					\includegraphics[width=0.25\textwidth]{"C:/Users/Vineet.Dairashri/AppData/Local/R/win-library/4.3/runidue/rmarkdown/templates/lectureslides/resources/kahootlogo2"}
...
\setbeamertemplate{frametitle}{%
	\makebox[\textwidth]{%
		...
		\includegraphics[width=2cm,keepaspectratio=true, valign=t]{"C:/Users/Vineet.Dairashri/AppData/Local/R/win-library/4.3/runidue/rmarkdown/templates/lectureslides/resources/duelogo"}
...
\begin{frame}{Motivation}
\phantomsection\label{motivation-7}
