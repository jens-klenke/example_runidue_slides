...
\input{"C:/Users/Vineet.Dairashri/AppData/Local/R/win-library/4.3/runidue/rmarkdown/templates/lectureslides/resources/ee.sty"}
...
\newenvironment<>{GeneralQuiz}[1]{%	
	...
	\end{center}}
	{\par\usebeamertemplate{block end}\end{actionenv}}
\newcommand{\Quizblock}[1]{\begin{GeneralQuiz}{#1}\end{GeneralQuiz}}
...
\GeneralQuiz{new section}\endGeneralQuiz
\end{frame}
